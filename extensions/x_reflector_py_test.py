...
sim.addHandler(name=x_reflector_py.name, subject='electron', \
               handler=x_reflector_py.handler(location=L/4+L/32,thickness=L/16),\
               dataDouble=x_reflector_py.dataDouble())
#sim.addHandler(name='xReflectorPyN', subject='electron', handler=x_reflector_py.xReflectorPyN.address)
#------------------------------adding electrons---------------------------------
